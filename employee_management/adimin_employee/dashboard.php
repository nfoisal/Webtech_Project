...
$obj_admin_class = new Admin_Class();


if (isset($GET['status'])) {
    if (isset($GET['logout']) == 'true') {
        $obj_admin_class->logout();
    }
}
...
//.....copyright@ Ahammad Foisol.......//
    ...
    <html>
        ...
        <body class="hold-transition skin-blue sidebar-mini">
            <div class="wrapper">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown user user-menu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="../asset/dashboard/img/foisal.jpg" class="user-image" alt="User Image">
                                        <span class="hidden-xs"></span><?php echo $_SESSION['admin_name'];?>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <!-- User image -->
                                        <li class="user-header">
                                            <img src="../asset/dashboard/img/foisal.jpg" class="img-circle" alt="User Image">
                                            <p>
                                                Ahammad Foisol
                                                <small>A new admin</small>
                                            </p>
                                        </li>
                                      ...
                                      <div class="pull-right">
                                          <a href="login_page.php" class="btn btn-default btn-flat"name="btn">Sign out</a>
                                         </div>
                                        </li>
                                    </ul>
                                </li>
                ...
                <aside class="main-sidebar">
                    ...
                    <section class="sidebar">
                        ...
                        <ul class="sidebar-menu">
                            <li class="header"><h4>Management</h4></li>
                            ...
                            <li>
                                <a href="employee_lists.php">
                                    <i class="fa fa-laptop"></i>
                                    <span class="hidden-tablet"> Employee Lists</span>
                                </a>
                            </li>
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="#"><i class="fa fa-circle-o"></i> Managing Directors </a></li>
                                    <li><a href="#"><i class="fa fa-circle-o"></i> Directors </a></li>
                                    <li><a href="#"><i class="fa fa-circle-o"></i> Assistant Directors </a></li>
                                    <li><a href="#"><i class="fa fa-circle-o"></i> Senior Executives </a></li>
                                    <li><a href="#"><i class="fa fa-circle-o"></i> Junior Executives </a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="../asset/dashboard/pages/calendar.html">
                                    <i class="fa fa-calendar"></i> <span>Calendar</span>
                                    <small class="label pull-right bg-red">3</small>
                                </a>
                            </li>
                            <li>
                                <a href="../asset/dashboard/pages/mailbox/mailbox.html">
                ...
                <div class="content-wrapper">
                    <?php
                    if (isset($pages)) {
                        if ($pages == 'dashboard_content') {
                            include '../pages/dashboard_content.php';
                        } elseif ($pages == 'employee_list') {
                            include '../pages/employee_list.php';
                        } elseif ($pages == 'manage_employee') {
                            include '../pages/manage_employee.php';
                        } elseif ($pages == 'payments') {
                            include '../pages/payments.php';
                        } elseif ($pages == 'form') {
                            include '../pages/form.php';
                        } elseif ($pages == 'edit_employee') {
                            include '../pages/edit_employee.php';
                        }
                    } else {
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2015-2016 <a href="https://www.facebook.com/nfoisal">Ahammad Foisal</a>.</strong> All rights reserved.
            </footer>
        ...
        <script src="../asset/dashboard/js/pageses/dashboard.js"></script>
